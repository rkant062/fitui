...
const testPlaylist = [
  {
    ...
    artist: "Coffee Vibes",
    duration: "0:30",
    // Using a test audio file that should work
        ...
        <Box sx={{ position: 'relative', zIndex: 1 }}>
          ...
          <Box sx={{ mt: 2, textAlign: 'center' }}>
            <Typography variant="caption" sx={{ opacity: 0.7 }}>
              Track {currentTrack + 1} of {testPlaylist.length} • Test Audio Collection
            </Typography>
          </Box>
        </Box>
      </Paper>
...
export default WorkingMusicPlayer;
